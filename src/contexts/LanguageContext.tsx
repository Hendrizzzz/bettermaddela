...
const translations = {
  en: {
    ...
    "record-verified": "Verified", "record-review-by": "Review by",
    "record-view-sources": "View sources",
    "record-group-label": "Sources and review details:",
  ...
  fil: {
    ...
    "record-verified": "Beripikado", "record-review-by": "Susuriin sa",
    "record-view-sources": "Tingnan ang mga sanggunian",
    "record-group-label": "Mga sanggunian at detalye ng pagsusuri:",
