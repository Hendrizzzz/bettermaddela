...
const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    'hero-subtitle':
      'Access government services, information, and resources for the people of Aurora, Zamboanga del Sur.',
    ...
    // Homepage - Stats
    'stats-at-a-glance': 'Aurora at a Glance',
    ...
    'weather-map-title': 'Weather and Map of Aurora',
    'weather-mainly-clear': 'Mainly clear',
    'weather-location': 'Aurora, Zamboanga del Sur',

    // Homepage - History
    'history-title': 'Brief History of Aurora',
    'history-1920':
      'The area was first settled by Cebuano pioneers who established a community known as the "Cebuano Barracks" along the Labangon River.',
    'history-1941':
      'Aurora was proclaimed a municipality under Executive Order No. 353 by President Manuel L. Quezon, named in honor of First Lady Doña Aurora Aragon Quezon.',
    'history-1956':
      'Mateo Ceniza became the first elected municipal mayor, marking the start of formal local governance.',
    'history-1970':
      'Mayor Gaudioso Cabahug led the municipality; the municipal hall and public schools were established.',
    'history-1980':
      'Mayor Jose Tecson continued infrastructure development and expanded basic services.',
    'history-1995':
      'Mayor Dominador Ceniza Jr. advanced growth and modernization programs across the municipality.',
    'history-2010':
      'Mayor Atty. Jerry Ceniza-Peligrina prioritized public service and community-driven development.',
    'history-pioneers-title': 'Cebuano Pioneers',
    'history-pioneers-desc':
      'The municipality traces its roots to Cebuano settlers who established a community by the Labangon River in the 1920s.',
    'history-namesake-title': 'Named for the First Lady',
    'history-namesake-desc':
      'Aurora was named in honor of First Lady Doña Aurora Aragon Quezon when it became a municipality under Executive Order No. 353.',
  ...
  fil: {
    ...
    // Homepage - Stats
    'stats-at-a-glance': 'Isang Tingin sa Aurora',
    ...
    // Homepage - Weather & Map
    'weather-map-title': 'Panahon at Mapa ng Aurora',
    'weather-mainly-clear': 'Halos maaliwalas',
    'weather-location': 'Aurora, Zamboanga del Sur',

    // Homepage - History
    'history-title': 'Maikling Kasaysayan ng Aurora',
    'history-1920':
      'Unang tinitirhan ng mga pioneer na Cebuano ang lugar at nagtatag ng komunidad na kilala bilang "Cebuano Barracks" sa tabi ng Ilog Labangon.',
    'history-1941':
      'Ipinroklama ang Aurora bilang bayan sa ilalim ng Executive Order No. 353 ni Pangulong Manuel L. Quezon, pinangalanan bilang parangal kay Ginang Doña Aurora Aragon Quezon.',
    'history-1956':
      'Si Mateo Ceniza ang naging unang halal na alkalde, nagsimula ang pormal na pamamahalang lokal.',
    'history-1970':
      'Pinamunuan ni Mayor Gaudioso Cabahug ang munisipalidad; itinatag ang munisipyo at mga pampublikong paaralan.',
    'history-1980':
      'Si Mayor Jose Tecson ang nagpatuloy sa pagpapaunlad ng imprastraktura at pagpapalawak ng batayang serbisyo.',
    'history-1995':
      'Si Mayor Dominador Ceniza Jr. ang nagtaguyod ng paglago at mga programang modernisasyon sa buong munisipalidad.',
    'history-2010':
      'Si Mayor Atty. Jerry Ceniza-Peligrina ang nagbigay ng prayoridad sa serbisyong publiko at komunidad na pag-unlad.',
    'history-pioneers-title': 'Mga Pioneer na Cebuano',
    'history-pioneers-desc':
      'Ang munisipyo ay nagmula sa mga pioneer na Cebuano na nagtatag ng komunidad sa tabi ng Ilog Labangon noong 1920s.',
    'history-namesake-title': 'Pinangalanan para sa Unang Ginang',
    'history-namesake-desc':
      'Ang Aurora ay pinangalanan bilang parangal kay Ginang Doña Aurora Aragon Quezon nang ito ay maging bayan sa ilalim ng Executive Order No. 353.',
  ...
  ilo: {
    ...
    // Hero Section
    'hero-welcome': 'Naragsak nga Isasangbay iti BetterAurora.org',
    'hero-subtitle':
    ...
    // Homepage - Stats
    'stats-at-a-glance': 'Maysa a Panagkita iti Aurora',
    ...
    // Homepage - Weather & Map
    'weather-map-title': 'Tiempo ken Mapa ti Aurora',
    'weather-mainly-clear': 'Kaaduan a nalawag',
    'weather-location': 'Aurora, Zamboanga del Sur',

    // Homepage - History
    'history-title': 'Ababa a Pakasaritaan ti Aurora',
    'history-1920':
      'Dagiti umuna a Cebuano a pioneer ti nagnaed iti lugar ken nangbangon iti komunidad nga ammo a kas "Cebuano Barracks" iti igid ti Labangon River.',
    'history-1941':
      'Naiproklama ti Aurora a kas munisipalidad babaen ti Executive Order No. 353 ni Presidente Manuel L. Quezon, naanagan kas panagdayaw ken ni Doña Aurora Aragon Quezon.',
    'history-1956':
      'Ni Mateo Ceniza ti immuna a naelehe a mayor ti munisipalidad, nangrugi ti pormal a lokal a gobierno.',
    'history-1970':
      'Ni Mayor Gaudioso Cabahug ti nangidaulo iti munisipalidad; naisangbay ti munisipio ken dagiti publiko nga eskuelan.',
    'history-1980':
      'Ni Mayor Jose Tecson ti nangtuloy iti pannakapasayaat ti imprastraktura ken panagwaras iti batay a serbisio.',
    'history-1995':
      'Ni Mayor Dominador Ceniza Jr. ti nangitaguyod iti panagdakkel ken modernisasion a programa iti intero a munisipalidad.',
    'history-2010':
      'Ni Mayor Atty. Jerry Ceniza-Peligrina ti nangited iti importansia ti serbisio publiko ken komunidad a panagdur-as.',
    'history-pioneers-title': 'Dagiti Pioneer a Cebuano',
    'history-pioneers-desc':
      'Ti munisipio ket nagtaudan kadagiti pioneer a Cebuano a nangbangon iti komunidad iti igid ti Labangon River idi 1920s.',
    'history-namesake-title': 'Naanagan para iti Umuna a Baket',
    'history-namesake-desc':
      'Ti Aurora ket naanagan kas panagdayaw ken ni Doña Aurora Aragon Quezon idi nagbalin a munisipalidad babaen ti Executive Order No. 353.',
