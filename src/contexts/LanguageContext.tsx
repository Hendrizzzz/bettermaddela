...
const translations = {
  en: {
    ...
    "nav-transparency": "Transparency", "nav-projects": "Projects", "nav-contact": "Contact",
    ...
    "a11y-open-nav": "Open navigation", "a11y-close-nav": "Close navigation",
    "a11y-main-nav": "Main navigation",
    "lang-to-en": "Switch to English", "lang-to-fil": "Switch to Filipino",
    "record-verified": "Checked", "record-review-by": "Review by",
    "record-view-sources": "View sources",
    "record-group-label": "Sources:",
    ...
    "footer-foi": "Freedom of Information", "footer-cost-label": "Cost to the people of Maddela",
    "footer-contribute": "Contribute on GitHub", "footer-foundation": "BetterAurora",
  ...
  fil: {
    "nav-home": "Home", "nav-services": "Serbisyo", "nav-government": "Pamahalaan",
    "nav-statistics": "Estadistika", "nav-legislative": "Lehislatura",
    "nav-transparency": "Transparency", "nav-projects": "Proyekto", "nav-contact": "Ugnayan",
    ...
    "skip-link": "Laktawan sa pangunahing nilalaman",
    "a11y-open-nav": "Buksan ang nabigasyon", "a11y-close-nav": "Isara ang nabigasyon",
    "a11y-main-nav": "Pangunahing nabigasyon",
    "lang-to-en": "Lumipat sa Ingles", "lang-to-fil": "Lumipat sa Filipino",
    "record-verified": "Nasuri", "record-review-by": "Susuriin sa",
    "record-view-sources": "Tingnan ang mga sanggunian",
    "record-group-label": "Mga sanggunian:",
    ...
    "footer-open-data": "Open Data Philippines",
    "footer-foi": "Kalayaan sa Impormasyon", "footer-cost-label": "Gastos sa mga tao ng Maddela",
    "footer-contribute": "Mag-ambag sa GitHub", "footer-foundation": "BetterAurora",
