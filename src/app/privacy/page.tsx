                    ...
                    <div className="legal-wrapper">
                        ...
                        <article className="legal-article">
                            <section id="introduction" className="legal-section">
                                <h2>Introduction</h2>
                                <p>
                                    BetterAurora.org (&quot;we,&quot; &quot;us,&quot; or &quot;our&quot;) is committed to
                            ...
                            <section id="data-sharing" className="legal-section">
                                ...
                                <ul className="legal-list">
                                    ...
                                    <li>
                                        ...
                                        of BetterAurora.org, our users, or the public
                                    </li>
                                    <li>
                            ...
                            <section id="your-rights" className="legal-section">
                                ...
                                <div className="legal-callout">
                                    ...
                                    <p>
                                        ...
                                        <a href="mailto:volunteer@betteraurora.org">volunteer@betteraurora.org</a>. We
                            ...
                            <section id="childrens-privacy" className="legal-section">
                                ...
                                <p>
                                    BetterAurora.org is a general audience website providing civic information. We do
                                ...
                                <p>
                                    ...
                                    <a href="mailto:volunteer@betteraurora.org">volunteer@betteraurora.org</a>, and we
