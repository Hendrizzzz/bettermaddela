          ...
          <div className="home-stats-v2-grid">
            <Link href="/statistics" className="home-stat-card">
              ...
              <div className="home-stat-card-content">
                <span className="home-stat-card-value">52,746</span>
            ...
            <Link href="/government" className="home-stat-card">
              ...
              <div className="home-stat-card-content">
                <span className="home-stat-card-value">44</span>
            ...
            <Link href="/statistics" className="home-stat-card">
              ...
              <div className="home-stat-card-content">
                <span className="home-stat-card-value">180.95 km²</span>
            ...
            <div className="map-column">
              <div className="map-card">
                <div
                  id="map-container"
                  role="application"
                  aria-label="Interactive map of Aurora, Zamboanga del Sur"
                  data-map-loaded="iframe"
                >
                  <iframe
                    src="https://www.openstreetmap.org/export/embed.html?bbox=123.55%2C7.92%2C123.61%2C7.98&layer=mapnik&marker=7.95%2C123.58"
                    className="map-iframe"
                    title="Map of Aurora, Zamboanga del Sur"
                    aria-label="OpenStreetMap showing Aurora Municipal Hall, Zamboanga del Sur"
                    loading="lazy"
                  ></iframe>
                </div>
                <p className="map-attribution">
                  <i className="bi bi-geo-alt" aria-hidden="true"></i> Aurora Municipal Hall,
                  Zamboanga del Sur 7020
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container">
          ...
          <div className="history-content">
            <div className="history-timeline">
              <div className="timeline-item" data-year="1920">
                <div className="timeline-marker"></div>
                <div className="timeline-content">
                  <span className="timeline-year">1920</span>
                  <p>{t('history-1920')}</p>
                </div>
              </div>
              <div className="timeline-item" data-year="1941">
                <div className="timeline-marker"></div>
                <div className="timeline-content">
                  <span className="timeline-year">1941</span>
                  <p>{t('history-1941')}</p>
                </div>
              </div>
              <div className="timeline-item" data-year="1956">
                <div className="timeline-marker"></div>
                <div className="timeline-content">
              ...
              <div className="timeline-item" data-year="1970">
                <div className="timeline-marker"></div>
                <div className="timeline-content">
              ...
              <div className="timeline-item" data-year="1980">
                <div className="timeline-marker"></div>
                <div className="timeline-content">
              ...
              <div className="timeline-item" data-year="1995">
                <div className="timeline-marker"></div>
                <div className="timeline-content">
              ...
              <div className="timeline-item" data-year="2010">
                <div className="timeline-marker"></div>
                <div className="timeline-content">
            ...
            <div className="history-summary">
              <div className="history-card">
                ...
                <div className="history-card-content">
                  <h4>{t('history-pioneers-title')}</h4>
                  <p>{t('history-pioneers-desc')}</p>
                </div>
              </div>
              <div className="history-card">
                <div className="history-card-icon">
                ...
                <div className="history-card-content">
                  <h4>{t('history-namesake-title')}</h4>
                  <p>{t('history-namesake-desc')}</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container">
          ...
          <div className="home-leadership-grid">
            <div className="home-leader-card">
              ...
              <h3>{officialsData.mayor.name}</h3>
              <div className="home-leader-contacts">
                <a href="mailto:lgu_aurorazds@yahoo.com">
                  <i className="bi bi-envelope"></i> lgu_aurorazds@yahoo.com
                </a>
            ...
            <div className="home-leader-card">
              ...
              <h3>{officialsData.vice_mayor.name}</h3>
              <div className="home-leader-contacts">
                <a href="mailto:lgu_aurorazds@yahoo.com">
                  <i className="bi bi-envelope"></i> lgu_aurorazds@yahoo.com
                </a>
      ...
      <section className="section">
        <div className="container">
          ...
          <div className="home-contact-v2-grid">
            <a href="tel:0623312067" className="home-contact-v2-card">
              <div className="home-contact-v2-icon">
                <i className="bi bi-telephone-fill"></i>
              </div>
              <div className="home-contact-v2-content">
                <h3>{t('contact-phone')}</h3>
                <p className="home-contact-v2-value">(062) 331-2067</p>
                <span className="home-contact-v2-note">{t('contact-hours')}</span>
              </div>
            </a>
            <a href="mailto:lgu_aurorazds@yahoo.com" className="home-contact-v2-card">
              <div className="home-contact-v2-icon">
                <i className="bi bi-envelope-fill"></i>
              </div>
              <div className="home-contact-v2-content">
                <h3>{t('contact-email')}</h3>
                <p className="home-contact-v2-value">lgu_aurorazds@yahoo.com</p>
            ...
            <div className="home-contact-v2-card">
              ...
              <div className="home-contact-v2-content">
                ...
                <span className="home-contact-v2-note">Aurora, Zamboanga del Sur 7020</span>
              </div>
            </div>
          </div>
        </div>
