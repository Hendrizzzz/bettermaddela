...
const sections = [
  ...
  { title: "Project", icon: "bi bi-info-circle", links: [["News", "/news"], ["FAQ", "/faq"], ["Accessibility", "/accessibility"], ["Security", "/security"], ["Privacy", "/privacy"], ["Terms of Use", "/terms"]] },
] as const;
        ...
        <div className="container">
          {sections.map((section) => (
            <div className="sitemap-section-new" key={section.title}>
              <div className="sitemap-section-header"><span className="sitemap-section-icon"><i className={section.icon} aria-hidden="true" /></span><h2>{section.title}</h2></div>
