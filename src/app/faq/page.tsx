        ...
        <div className="container">
          <div className="faq-container">
            <div className="faq-category">
              <div className="faq-category-header"><i className="bi bi-info-circle-fill" aria-hidden="true" /><h2>About BetterMaddela</h2></div>
            ...
            <div className="faq-category">
              <div className="faq-category-header"><i className="bi bi-gear-fill" aria-hidden="true" /><h2>Using the site</h2></div>
              <div className="faq-list">
