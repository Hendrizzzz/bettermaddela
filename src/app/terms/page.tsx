...
export default function TermsPage() {
    return (
        <>
            <PageHeader
                title="Terms of Use"
                description="Guidelines for using BetterAurora.org"
                        ...
                        <article className="legal-article">
                            ...
                            <section id="availability" className="legal-section">
                                ...
                                <p>
                                    ...
                                    BetterAurora.org cannot guarantee that the website will be:
                                </p>
                                <ul className="legal-list">
                            ...
                            <section id="takedown" className="legal-section">
                                ...
                                <p>
                                    BetterAurora.org values accuracy, public safety, and respect for rights. Despite
                                ...
                                <p>
                                    ...
                                    <a href="mailto:volunteer@betteraurora.org">volunteer@betteraurora.org</a>
                                </p>
                            ...
                            <section id="contact" className="legal-section">
                                ...
                                <div className="legal-contact">
                                    <a href="mailto:volunteer@betteraurora.org" className="contact-link">
                                        <i className="bi bi-envelope-fill"></i>
                                        <span>volunteer@betteraurora.org</span>
                                    </a>
                                </div>
                                <p className="legal-closing">
                                    BetterAurora.org provides public domain information to support civic engagement,
