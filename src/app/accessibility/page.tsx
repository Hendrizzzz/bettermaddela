                ...
                <div className="container">
                    <div className="a11y-container">
                        ...
                        <div className="a11y-section">
                            ...
                            <p>
                                BetterAurora.org is committed to ensuring digital accessibility for people with
                        ...
                        <div className="a11y-section">
                            ...
                            <div className="a11y-contact-grid">
                                <a href="mailto:volunteer@betteraurora.org" className="a11y-contact-item">
                        ...
                        <div className="a11y-promise">
                            ...
                            <div>
                                <h3>Our Promise</h3>
                                <p>
                                    BetterAurora.org is committed to ensuring that our digital services are accessible to
