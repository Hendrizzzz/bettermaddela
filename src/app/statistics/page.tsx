    ...
    return (
        <>
            <PageHeader
                ...
                description="Data and statistics about Aurora, Zamboanga del Sur"
            ...
            <section className="stats-section stats-economy animate-on-scroll">
                <div className="container">
                    ...
                    <p className="data-source">
                        <i className="bi bi-info-circle"></i> Source:{" "}
                        <a href="https://region9.dilg.gov.ph/aurora/" target="_blank" rel="noopener noreferrer">
                            Department of the Interior and Local Government (DILG) Region IX
                        </a>
                        {" "}- Aurora Municipal Profile
                    </p>
                </div>
            </section>
            ...
            <section className="stats-section stats-competitive animate-on-scroll" id="competitive-index">
                <div className="container">
                    <div className="section-header-minimal">
                        ...
                        <h2>Aurora Competitive Index</h2>
                        <p>
