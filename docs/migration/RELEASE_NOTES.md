...
This release completes the migration of BetterAurora.org to a single Next.js + TypeScript application at the repository root. The legacy static HTML site, the separate `react-app/` directory, and the Python development server have been retired.
